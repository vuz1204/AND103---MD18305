...
import fpoly.vunvph33438.lab5.adapter.DistributorAdapter;
import fpoly.vunvph33438.lab5.databinding.ActivityMainBinding;
import fpoly.vunvph33438.lab5.databinding.DialogAddBinding;
...
public class MainActivity extends AppCompatActivity implements DistributorAdapter.DistributorClick {
        ...
        binding1.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty()) {
                    ...
                    httpRequest.callAPI().updateDistributor(distributor.getId(), distributor1).enqueue(responseDistributorAPI);
                    alertDialog.dismiss();
                }
            }
        });
    ...
    public void delete(Distributor distributor) {
        ...
        builder.setPositiveButton("yes", (dialog, which) -> {
            httpRequest.callAPI().deleteDistributor(distributor.getId()).enqueue(responseDistributorAPI);
        });
